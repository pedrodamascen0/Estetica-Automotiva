 ...
 * "BuildFailure" object.
 *
 * This function is the primary entry point for using the esbuild API. You can
 * use it to build a single file, a collection of files, or an entire project.
 * It supports a wide range of configuration options, including support for
 * plugins, watching for changes, and hosting a local development server.
 *
 * - Works in node: yes
 ...
 * @returns A promise that resolves with a "BuildResult" object or rejects with a
 * "BuildFailure" object.
 */
export declare function esbuild<T extends BuildOptions>(options: SameShape<BuildOptions, T>): Promise<BuildResult<T>>
/**
 * esbuild command-line tool options
 *
 * Documentation: https://esbuild.github.io/api/#build
 */
